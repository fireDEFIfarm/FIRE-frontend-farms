...
const PrizeGrid: React.FC<PrizeGridProps> = ({
  ...
  return (
    <Grid pastDraw={pastDraw}>
      ...
      <GridItem>
        <RightAlignedHeading size="md">~${(eggPrice * fourMatchesAmount).toFixed(2)}</RightAlignedHeading>
      </GridItem>
      {/* 3 matches row */}
      <GridItem>
        <Text bold>3</Text>
      ...
      <GridItem>
        <RightAlignedText>~${(eggPrice * threeMatchesAmount).toFixed(2)}</RightAlignedText>
      </GridItem>
      {/* 2 matches row */}
      ...
      <GridItem>
        <RightAlignedText>~${(eggPrice * twoMatchesAmount).toFixed(2)}</RightAlignedText>
      </GridItem>
      {/* Burn row */}
      ...
      {pastDraw ? (
        <>
          ...
          <GridItem>
            <RightAlignedText>~${(eggPrice * burnAmount).toFixed(2)}</RightAlignedText>
          </GridItem>
        </>
      ) : (
        <GridItem marginBottom="0">
